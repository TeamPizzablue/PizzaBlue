						...
						<div class="col-lg-4 col-lg-offset-4">
								...
								<div class="form-group col-xs-6"> <!-- ei voi syöttää kirjaimia, vain numeroita 5 kpl -->
									<label for="Postinumero">Postinumero: * </label><input
										class="form-control" type="text" pattern="[0-9]{5}" id="Postinumero" name="postinumero"
										style="color: black" oninvalid="setCustomValidity('Syötä vain numeroita! ')"
 										   onchange="try{setCustomValidity('')}catch(e){}" required> 
								</div>
								<div class="form-group col-xs-6"> <!-- ei voi syöttää numeroita, vain kirjaimia -->
									<label for="Paikkakunta">Paikkakunta: * </label><input
										class="form-control" type="text" id="Paikkakunta" name="paikkakunta" pattern="[A-Za-z]*" style="color:black" oninvalid="setCustomValidity('Syötä vain kirjaimia! ')"
